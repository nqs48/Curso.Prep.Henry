...
function todosIguales(arreglo) {
  ...
  for (let index = 1; index < arreglo.length; index++) {
      comparador=arreglo[index-1]
      if(comparador!==arreglo[index]){
        return false;
      }     
    }
    return true; 
...
function mesesDelAño(array) {
  ...
  // Tu código:
  let encontrados=[]
  let enero=0,marzo=0,noviembre=0;
  ...
  }else if (enero > 0 && marzo > 0 && noviembre > 0) {
    return encontrados;
  }
}
